...
Tab and group information is used only to decide whether Chrome should unload an idle tab and to show the result on the Activity page. The information is not used for advertising, profiling, or any unrelated purpose.
...
TabLean's use of information received from Chrome APIs follows the Chrome Web Store User Data Policy, including its Limited Use requirements.

## Changes to this policy

If TabLean's data handling changes, this policy will be updated before the related version is released.
